...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./ModelPackage'));
  } else {
    // Browser globals (root is window)
    if (!root.ScubawhereApiDocumentation) {
      root.ScubawhereApiDocumentation = {};
    }
    root.ScubawhereApiDocumentation.InlineResponse20032 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.ModelPackage);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('course')) {
        obj['course'] = ModelPackage.constructFromObject(data['course']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/ModelPackage} course
   */
