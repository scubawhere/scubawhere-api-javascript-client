...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse20038 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.Refund);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payments')) {
        obj['payments'] = ApiClient.convertToType(data['payments'], [Refund]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Refund>} payments
   */
