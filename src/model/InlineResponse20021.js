...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse20021 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.Training);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('course')) {
        obj['course'] = Training.constructFromObject(data['course']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Training} course
   */
