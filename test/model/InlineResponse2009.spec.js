...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ScubawhereApiDocumentation.InlineResponse2009();
  });
  ...
  describe('InlineResponse2009', function() {
    it('should create an instance of InlineResponse2009', function() {
      ...
      //var instane = new ScubawhereApiDocumentation.InlineResponse2009();
      //expect(instance).to.be.a(ScubawhereApiDocumentation.InlineResponse2009);
    });
    ...
    it('should have the property addonDecimalPrice (base name: "addon_decimal_price")', function() {
      // uncomment below and update the code to test the property addonDecimalPrice
      //var instane = new ScubawhereApiDocumentation.InlineResponse2009();
      //expect(instance).to.be();
    });
