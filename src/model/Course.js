...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.Course = factory(root.ScubawhereApiDocumentation.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('certificate_id')) {
        obj['certificate_id'] = ApiClient.convertToType(data['certificate_id'], 'Integer');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Integer} certificate_id
   */
  exports.prototype['certificate_id'] = undefined;
