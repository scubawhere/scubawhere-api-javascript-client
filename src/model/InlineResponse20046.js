...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse20046 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.Trip);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('course')) {
        obj['course'] = Trip.constructFromObject(data['course']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Trip} course
   */
