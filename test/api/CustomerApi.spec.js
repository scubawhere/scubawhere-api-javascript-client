...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ScubawhereApiDocumentation.CustomerApi();
  });
  ...
  describe('CustomerApi', function() {
    describe('createCustomer', function() {
      it('should call createCustomer successfully', function(done) {
        ...
        //instance.createCustomer(pet, function(error) {
    ...
    describe('editCustomer', function() {
      it('should call editCustomer successfully', function(done) {
        //uncomment below and update the code to test editCustomer
        //instance.editCustomer(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getAllCustomers', function() {
      it('should call getAllCustomers successfully', function(done) {
        ...
        //instance.getAllCustomers(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
