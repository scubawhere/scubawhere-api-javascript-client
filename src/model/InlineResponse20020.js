...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse20020 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.TrainingSession);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('agent')) {
        obj['agent'] = TrainingSession.constructFromObject(data['agent']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/TrainingSession} agent
   */
