...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ScubawhereApiDocumentation.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instane = new ScubawhereApiDocumentation.Location();
      //expect(instance).to.be.a(ScubawhereApiDocumentation.Location);
    });
