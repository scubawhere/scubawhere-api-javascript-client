...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ScubawhereApiDocumentation.BasePrice();
  });
  ...
  describe('BasePrice', function() {
    it('should create an instance of BasePrice', function() {
      // uncomment below and update the code to test BasePrice
      //var instane = new ScubawhereApiDocumentation.BasePrice();
      //expect(instance).to.be.a(ScubawhereApiDocumentation.BasePrice);
    });
