...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.Timetable = factory(root.ScubawhereApiDocumentation.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('weeks')) {
        obj['weeks'] = ApiClient.convertToType(data['weeks'], 'Integer');
      }
