...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ScubawhereApiDocumentation.Course();
  });
  ...
  describe('Course', function() {
    it('should create an instance of Course', function() {
      ...
      //var instane = new ScubawhereApiDocumentation.Course();
      //expect(instance).to.be.a(ScubawhereApiDocumentation.Course);
    });
