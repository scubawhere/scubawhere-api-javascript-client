...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ScubawhereApiDocumentation.Boat();
  });
  ...
  describe('Boat', function() {
    it('should create an instance of Boat', function() {
      // uncomment below and update the code to test Boat
      //var instane = new ScubawhereApiDocumentation.Boat();
      //expect(instance).to.be.a(ScubawhereApiDocumentation.Boat);
    });
