...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse2007 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.Booking);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('agent')) {
        obj['agent'] = Booking.constructFromObject(data['agent']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Booking} agent
   */
