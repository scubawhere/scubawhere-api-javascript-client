...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse20030 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.Customer);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('agent')) {
        obj['agent'] = Customer.constructFromObject(data['agent']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Customer} agent
   */
