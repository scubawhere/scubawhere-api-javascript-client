...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ScubawhereApiDocumentation.InlineResponse2002();
  });
  ...
  describe('InlineResponse2002', function() {
    it('should create an instance of InlineResponse2002', function() {
      ...
      //var instane = new ScubawhereApiDocumentation.InlineResponse2002();
      //expect(instance).to.be.a(ScubawhereApiDocumentation.InlineResponse2002);
    });
    ...
    it('should have the property accommodation (base name: "accommodation")', function() {
      // uncomment below and update the code to test the property accommodation
      //var instane = new ScubawhereApiDocumentation.InlineResponse2002();
      //expect(instance).to.be();
    });
