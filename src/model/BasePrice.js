...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.BasePrice = factory(root.ScubawhereApiDocumentation.ApiClient);
  }
  ...
  /**
   * The BasePrice model module.
   * @module model/BasePrice
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>BasePrice</code>.
   * @alias module:model/BasePrice
   * @class
   */
  ...
  /**
   * Constructs a <code>BasePrice</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BasePrice} obj Optional instance to populate.
   * @return {module:model/BasePrice} The populated <code>BasePrice</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('decimal_price')) {
        obj['decimal_price'] = ApiClient.convertToType(data['decimal_price'], 'Integer');
      }
    }
    return obj;
  }
