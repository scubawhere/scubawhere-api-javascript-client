...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ScubawhereApiDocumentation.CompanyApi();
  });
  ...
  describe('CompanyApi', function() {
    describe('attachLocations', function() {
      it('should call attachLocations successfully', function(done) {
        //uncomment below and update the code to test attachLocations
        //instance.attachLocations(pet, function(error) {
    ...
    describe('getLocations', function() {
      it('should call getLocations successfully', function(done) {
        ...
        //instance.getLocations(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPickupSchedule', function() {
      it('should call getPickupSchedule successfully', function(done) {
        ...
        //instance.getPickupSchedule(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
