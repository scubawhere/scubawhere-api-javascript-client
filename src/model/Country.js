...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.Country = factory(root.ScubawhereApiDocumentation.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('countinent_id')) {
        obj['countinent_id'] = ApiClient.convertToType(data['countinent_id'], 'Integer');
      }
  ...
  /**
   * @member {Integer} countinent_id
   */
  exports.prototype['countinent_id'] = undefined;
  /**
