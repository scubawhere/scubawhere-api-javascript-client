...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse20029 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.Customer);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('course')) {
        obj['course'] = Customer.constructFromObject(data['course']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Customer} course
   */
