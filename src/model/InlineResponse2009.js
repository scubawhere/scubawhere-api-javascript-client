...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse2009 = factory(root.ScubawhereApiDocumentation.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('addon_decimal_price')) {
        obj['addon_decimal_price'] = ApiClient.convertToType(data['addon_decimal_price'], 'String');
      }
    }
    return obj;
  }
  ...
  /**
   * @member {String} addon_decimal_price
   */
  exports.prototype['addon_decimal_price'] = undefined;
