...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ScubawhereApiDocumentation.Schedule();
  });
  ...
  describe('Schedule', function() {
    it('should create an instance of Schedule', function() {
      ...
      //var instane = new ScubawhereApiDocumentation.Schedule();
      //expect(instance).to.be.a(ScubawhereApiDocumentation.Schedule);
    });
