...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse20036 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.Payment);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('paymentgateways')) {
        obj['paymentgateways'] = ApiClient.convertToType(data['paymentgateways'], [Payment]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Payment>} paymentgateways
   */
  exports.prototype['paymentgateways'] = undefined;
