...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse20039 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.Payment);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('refunds')) {
        obj['refunds'] = ApiClient.convertToType(data['refunds'], [Payment]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Payment>} refunds
   */
