...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse20043 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.Session);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('course')) {
        obj['course'] = Session.constructFromObject(data['course']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Session} course
   */
