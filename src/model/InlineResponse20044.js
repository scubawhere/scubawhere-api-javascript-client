...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ScubawhereApiDocumentation.InlineResponse20044 = factory(root.ScubawhereApiDocumentation.ApiClient, root.ScubawhereApiDocumentation.Session);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('agent')) {
        obj['agent'] = Session.constructFromObject(data['agent']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Session} agent
   */
